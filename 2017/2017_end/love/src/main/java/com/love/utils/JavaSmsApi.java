...
public class JavaSmsApi {
    ...
    public static final String apikey = "488e792f6452fbf4caa8cb0369357b20";

    public static void main(String[] args) throws IOException,
            URISyntaxException {

        //修改为您要发送的手机号
        String mobile = "18717075962";
        ...
        String text = "【云片网】您的验证码是:哈哈哈哈哈哈哈";
        //发短信调用示例
    ...
    public String tplSendSms(long tpl_id, String tpl_value,
