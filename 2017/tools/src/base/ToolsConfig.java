...
import controller.CryptoUtilsController;
import controller.DateFormatController;
...
public class ToolsConfig extends JFinalConfig{
	...
	public void configConstant(Constants me) {
		...
		me.setDevMode(true);
		me.setError404View("WEB-INF/html/common/error404.html");
		me.setError500View("WEB-INF/html/common/error500.html");
		
	}

	@Override
	public void configRoute(Routes me) {
		//配置路由    第一个参数配置的访问controller的路径，后面的是配置返回页面的路径 /WEB-INF/html/system
		me.add("/dateFormat",DateFormatController.class,"/WEB-INF/html/time");
		me.add("/ctypto",CryptoUtilsController.class,"/WEB-INF/html/crypto");
	...
	public void configInterceptor(Interceptors me) {
		...
		//me.add(new LoginInterceptor());//拦截未登录的账户
