...
public class SelectSheetVo {
    ...
    public String getOrSheetTypeString() {
        return orSheetTypeString;
    }

    public void setOrSheetTypeString(String orSheetTypeString) {
        this.orSheetTypeString = orSheetTypeString;
    }
}
