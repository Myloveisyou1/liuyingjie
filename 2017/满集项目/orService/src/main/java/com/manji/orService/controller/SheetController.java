...
public class SheetController extends BaseController {
    ...
    public Object selectSheetDetails(@RequestParam(value = "id", required = true) int id, @RequestParam(value = "sendId", required = false) Integer sendId, @RequestParam(value = "sessionId", required = true) String sessionId) {
        ...
        try {
            ...
            hashMapList = sheetService.selectSheetDetails(id, account);
        } catch (Exception e) {
...
//        JSONObject o = nameArray.getJSONObject(0);
        ...
        try {
            ...
            JSONArray object = feignService.findExaminePeople(account.getUser().getId(), "/sheet/examine");
            if(object.size()>0){
                ...
                return message(ErrorCodeEnums.AuditAuthority.getCode(), ErrorCodeEnums.AuditAuthority.getMessage(), null);//返回结果
            }
