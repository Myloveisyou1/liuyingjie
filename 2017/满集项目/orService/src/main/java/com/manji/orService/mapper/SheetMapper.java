...
public interface SheetMapper {
     ...
     * @return
     */
    @Update("update or_informations set is_see=0,is_push=0 where or_handle_id=#{userId} and or_sheet_id=#{sheetId}")
    boolean clearInformationsSheetId(@Param("userId")int userId,@Param("sheetId")int sheetId);
