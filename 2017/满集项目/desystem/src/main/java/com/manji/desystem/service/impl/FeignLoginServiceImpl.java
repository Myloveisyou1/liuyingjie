...
public class FeignLoginServiceImpl implements FeignLoginService {
    ...
    public Account login(String username, String password) throws Exception{
        String sign = MD5Utils.formatUpper32(username + MD5Utils.formatUpper32(password) + Configure.getCode() + "manji");
        return loginInterface.login(username,MD5Utils.formatUpper32(password),Configure.getCode(),sign);
    }
